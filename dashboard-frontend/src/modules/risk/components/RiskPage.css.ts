...
export const constraintList = style({
  display: "flex",
  flexDirection: "column",
  gap: vars.space[2],
});

export const constraintItem = style({
  display: "flex",
  flexDirection: "column",
  gap: vars.space[2],
...
export const constraintHeader = style({
  display: "flex",
...
export const constraintMeta = style({
  display: "flex",
  flexDirection: "column",
  gap: vars.space[1],
});
...
export const constraintNote = style({
