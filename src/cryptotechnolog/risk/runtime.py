        ...
        *,
        ...
        return cls(
            ...
            correlation=CorrelationConfig(
                ...
                same_group_correlation=Decimal(str(settings.same_group_correlation)),
                cross_group_correlation=Decimal(str(settings.cross_group_correlation)),
            ),
            trailing=TrailingPolicyConfig(
                arm_at_pnl_r=Decimal(str(settings.trailing_arm_at_pnl_r)),
                t2_at_pnl_r=Decimal(str(settings.trailing_t2_at_pnl_r)),
                t3_at_pnl_r=Decimal(str(settings.trailing_t3_at_pnl_r)),
                t4_at_pnl_r=Decimal(str(settings.trailing_t4_at_pnl_r)),
                t1_atr_multiplier=Decimal(str(settings.trailing_t1_atr_multiplier)),
                t2_atr_multiplier=Decimal(str(settings.trailing_t2_atr_multiplier)),
                t3_atr_multiplier=Decimal(str(settings.trailing_t3_atr_multiplier)),
                t4_atr_multiplier=Decimal(str(settings.trailing_t4_atr_multiplier)),
                emergency_buffer_bps=Decimal(str(settings.trailing_emergency_buffer_bps)),
                structural_min_adx=Decimal(str(settings.trailing_structural_min_adx)),
            ...
            funding=FundingManagerConfig(
                min_arbitrage_spread=Decimal(str(settings.funding_min_arbitrage_spread)),
                min_annualized_spread=Decimal(str(settings.funding_min_annualized_spread)),
                max_acceptable_funding=Decimal(str(settings.funding_max_acceptable_rate)),
                min_exchange_improvement=Decimal(str(settings.funding_min_exchange_improvement)),
