...
- `selection_report` с `target_expiry_ts_ms`/`selected_expiry_ts_ms`, UTC `target_expiry_date`/`selected_expiry_date` и derived `strike_mismatch`/`expiry_mismatch` flags,
- `probe_reports`,
- `ingestion_report`,
- `replay_summary`,
- `errors`.
